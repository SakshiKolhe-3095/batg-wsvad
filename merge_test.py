...
SOURCE_ROOT = Path(r"D:\Research_Internship\data\features\ucf-crime\i3d\test_v2\Test\RGB")
DEST_DIR = Path(r"D:\Research_Internship\data\features\ucf-crime\i3d\test_merged")
...
print(f"Merged {merged_count} videos successfully ({trimmed_count} required trimming)")
